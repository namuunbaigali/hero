...
/** ----------------- Toolbar ----------------- */
function EnhancedTableToolbar({ numSelected, query, onQueryChange }: EnhancedTableToolbarProps) {
  return (
    <Toolbar
      sx={[
        { pl: { sm: 2 }, pr: { xs: 1, sm: 1 }, gap: 1.5 },
        numSelected > 0 && {
          bgcolor: (theme) =>
    ...
    >
      <Typography sx={{ flex: "1 1 auto" }} variant="h6" id="tableTitle" component="div">
...
export default function EnhancedTable() {
  ...
  const [orderBy, setOrderBy] = React.useState<keyof RowData>("calories");
  ...
  const handleClick = (_event: React.MouseEvent<unknown>, id: number) => {
    ...
    else newSelected = newSelected.concat(selected.slice(0, selectedIndex), selected.slice(selectedIndex + 1));
